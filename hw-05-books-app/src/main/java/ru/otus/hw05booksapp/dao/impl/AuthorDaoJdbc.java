...
public class AuthorDaoJdbc implements AuthorDao {
    ...
    public Author findById(long id) {
        ...
        return jdbc.queryForObject("SELECT id, name FROM author WHERE id = :id", params, new AuthorMapper());
    }

    @Override
    public Author findByName(String name) {
        var params = Map.of("name", name);
        return jdbc.queryForObject("SELECT id, name FROM author WHERE name = :name", params, new AuthorMapper());
    }
