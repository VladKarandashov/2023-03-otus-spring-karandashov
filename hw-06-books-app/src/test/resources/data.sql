...
INSERT INTO author(name) VALUES ('Антуан Сент-Экзюпери');
INSERT INTO author(name) VALUES ('Александр Дюма');
INSERT INTO author(name) VALUES ('Братья Стругацкие');
...
INSERT INTO book(author_id, genre_id, title) VALUES (1, 1, 'MasterTest');
...
INSERT INTO book(author_id, genre_id, title) VALUES (4, 3, 'Отель у альпениста');

INSERT INTO note(book_id, note) VALUES (1,  'Note-01.1 - Master');
